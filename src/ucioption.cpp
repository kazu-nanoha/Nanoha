...
void init(OptionsMap& o) {
  ...
  o["RandomBookSelect"]      << Option(false);
#if 0
  o["BookFile"]              << Option("public.jsk");
#else
  o["BookFile"]              << Option("book_40.jsk");
#endif
#endif
...
#if defined(NANOHA)
  o["Output_AllDepth"]       << Option(false);
  o["ByoyomiMargin"]         << Option(1800, 0, 3000);
#if defined(USE_DFPN)
  o["UseMate"]               << Option(true);;
#if defined(_M_X64)
  o["MateHashMB"]            << Option(256, 64, 8192);
#else
  o["MateHashMB"]            << Option(256, 64, 2048);
#endif
#endif
#endif
#if !defined(NANOHA)
